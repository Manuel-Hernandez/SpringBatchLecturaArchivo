package com.procesos.configuration;
...
import com.procesos.conexion.Conexion;
import com.procesos.listener.JobListener;
import com.procesos.model.Persona;
import com.procesos.processor.PersonaItemProcessor;
...
public class BatchConfiguration {
	...
	public JdbcBatchItemWriter<Persona> writer(DataSource dataSource){
       return new JdbcBatchItemWriterBuilder<Persona>()
    		   ...
    		   .sql("insert into entrada (nombre,apellido,edad) VALUES (:nombre, :apellido, :edad)")
	...
	//Job
	@Bean
	public Job imporPersonaJob(JobListener listener, Step step1){
		return jobBuilderFactory.get("imporPersonaJob")
